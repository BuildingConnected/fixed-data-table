...
/***/ (function(module, exports, __webpack_require__) {
	...
	var throttle = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"lodash.throttle\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var FixedDataTable = createReactClass({
	  ...
	  getInitialState: function getInitialState() /*object*/{
	    ...
	    return _extends({}, this._calculateState(this.props), {
	  ...
	  setHoverState: function setHoverState(hoverState) {
	      ...
	      columnResizerComponent = React.createElement(
	        'div',
	        {
	          ...
	          onMouseEnter: function () {
	            return props.setHoverState(true);
	          },
	          onMouseLeave: function () {
	            return props.setHoverState(false);
	          } },
	        React.createElement('div', {
